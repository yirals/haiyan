...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    self.nameLable = [[UILabel alloc] initWithFrame:CGRectMake(0, self.cell.frame.size.height*9/10, self.cell.frame.size.width, self.cell.frame.size.height/9)];
    ...
    self.showImag = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.cell.frame.size.width, self.cell.frame.size.height*9/10)];
...
//    self.showImag = [UIImage imageNamed:self.listArray[indexPath.row][@"cover"]];
    ...
    [self.cell addSubview:self.nameLable];
    [self.cell addSubview:self.showImag];
